...
<html>
<head>
	<title>Contrato para oficina virtual intermedio de persona física a persona física</title>
	...
	<ul class="b-up-alpha less-li-he justify">
		<li class="one-line-sp">De los servicios en general:
			<ul class="no-style no-padding no-margin">
				...
				<li>A-4) Sala de juntas con servicio de proyección (3 horas mensuales de acuerdo a disponibilidad). Las horas de sala de juntas no son acumulables</li>
