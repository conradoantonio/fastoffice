...
<div class="start-page">
	...
	<ul class="b-up-alpha justify">
		...
		<li class="one-line-sp">Que {{$contract->customer->name}} tiene facultades para suscribir el presente instrumento de conformidad con la escritura {{$contract->customer_deed_number}} de fecha {{$contract->customer_deed_date}} otorgada ante la fe del notario público número {{$contract->customer_notary_number}} del estado de {{$contract->customer_notary_state->name}}.</li>
