		...
		@foreach($contracts as $contract)
			<tr>
				...
				<td>
					...
					<a href="{{route('Crm.prospects.generate_contract', [$contract->application->id, $contract->id])}}" class="btn btn-xs btn-mini btn-edit edit-row" data-toggle="tooltip" data-parent-id="{{$contract->id}}" data-placement="top" title="Editar"><i class="fa fa-pencil"></i></a>
					...
					<a class="btn btn-xs btn-mini btn-primary view-contract" href="{{route('Crm.prospects.view_contract', $contract->id)}}" target="_blank" data-toggle="tooltip" data-placement="top" title="Ver contrato"><i class="fa fa-eye"></i></a>
